...
# AGENTS.md - Codex CLI working agreement for Salone Explorer

You are Codex CLI. This file is your project memory: the Codex CLI counterpart
...
Codex CLI. Where the rules and CLAUDE.md below reference those mechanisms,
...
- No automated `reset --hard` / `push --force` block: the git hooks
  ...
  bypass the hooks.
- No automated reviewer agents: request human review before merge. Codex CLI
